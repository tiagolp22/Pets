    ...
    <main class="flex-auto">
        <div class="flex items-center justify-center min-h-screen">
            ...
            <div class="max-w-md mx-auto text-center bg-white bg-opacity-90 p-8 rounded-lg shadow-lg relative z-10">
                ...
                <a href="{{ route('index') }}" class="inline-block bg-indigo-600 text-white font-semibold px-6 py-3 rounded-md hover:bg-indigo-700 transition-colors duration-300">Retourner à la page d'accueil</a>
            </div>
        </div>
    </main>
@endsection
